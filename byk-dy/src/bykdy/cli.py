...
from bykdy.douyin.crawler import DouyinWebCrawler
...
def dy(ctx: CommandContext, input_text: str | None,
       no_download: bool, set_cookie: str | None, download_dir: str | None,
       show_config: bool):
    """
    用法:

        byk dy <URL | 分享文案 | 作品ID>

        byk dy --set-cookie "你的Cookie"

        byk dy --download-dir ~/Videos
...
if __name__ == "__main__":
    console.print("[yellow]请通过 byk CLI 运行: byk dy <URL>[/yellow]")
