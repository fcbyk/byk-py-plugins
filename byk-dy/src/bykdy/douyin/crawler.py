...
# 基础爬虫客户端和抖音API端点
from bykdy.base_crawler import BaseCrawler
from bykdy.douyin.endpoints import DouyinAPIEndpoints
# 抖音接口数据请求模型
from bykdy.douyin.models import (
...
# 抖音应用的工具类
from bykdy.douyin.utils import (AwemeIdFetcher,  # Aweme ID获取
...
class DouyinWebCrawler:
    ...
    def __init__(self, cookie: str = ""):
        ...
        Args:
            cookie: 抖音 Cookie 字符串，由 CLI 从 ~/.byk/state/dy/state.json 读取并传入
        """
        self.cookie = cookie
    ...
    async def get_douyin_headers(self):
        ...
        kwargs = {
            "headers": {
                ...
                "Cookie": self.cookie or douyin_config["headers"].get("Cookie", ""),
            },
